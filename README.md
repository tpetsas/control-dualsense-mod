...
[installer-link]: https://github.com/tpetsas/control-dualsense-mod/releases/download/v2.3.1/Control-DualSensitive-Mod_Setup.exe
...
[Control DualSense Mod v2.3.1]: https://github.com/tpetsas/control-dualsense-mod/releases/tag/v2.3.1
...
**1. Download the **[Control-DualSensitive-Mod_Setup.exe][installer-link]** from the latest version ([Control DualSense Mod v2.3.1])**
...
[binaries-link]: https://github.com/tpetsas/control-dualsense-mod/releases/download/v2.3.1/Control-DualSensitive-Mod_Binaries.zip
